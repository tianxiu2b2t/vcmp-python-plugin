...
def set_game_mode_text() -> None: ...
def get_game_mode_text() -> str: ...

def shutdown_server() -> None: ...

def set_server_option(option: vcmpServerOption, value: bool) -> None: ...
...
def is_weapon_data_value_modified(weapon_id: int, field_id: int) -> int: ...
def reset_weapon_data(weapon_id: int) -> None: ...
def reset_all_weapon_data() -> None: ...

def get_key_bind_unused_slot() -> int: ...
def get_key_bind_data(bind_id: int, is_called_on_release_out: bytearray, key_one_out: bytearray, key_two_out: bytearray, key_three_out: bytearray) -> int: ...
...
def set_player_admin(player_id: int, toggle: int) -> None: ...
def get_player_ip(player_id: int, buffer: bytearray, size: int) -> int: ...
def get_player_uid(player_id: int, buffer: bytearray, size: int) -> int: ...
def get_player_uid2(player_id: int, buffer: bytearray, size: int) -> int: ...
...
def get_player_name(player_id: int, buffer: bytearray, size: int) -> int: ...
def set_player_name(player_id: int, name: str) -> int: ...
def get_player_state(player_id: int) -> int: ...
def set_player_option(player_id: int, option: int, toggle: int) -> None: ...
def get_player_option(player_id: int, option: int) -> int: ...
...
def set_vehicle_option(vehicle_id: int, option: int, toggle: int) -> None: ...
def get_vehicle_option(vehicle_id: int, option: int) -> int: ...
...
def is_vehicle_wrecked(vehicle_id: int) -> int: ...
...
def set_vehicle_speed(vehicle_id: int, x: float, y: float, z: float, add: int, relative: int) -> None: ...
def get_vehicle_speed(vehicle_id: int, x_out: bytearray, y_out: bytearray, z_out: bytearray, relative: int) -> int: ...
def set_vehicle_turn_speed(vehicle_id: int, x: float, y: float, z: float, add: int, relative: int) -> None: ...
def get_vehicle_turn_speed(vehicle_id: int, x_out: bytearray, y_out: bytearray, z_out: bytearray, relative: int) -> int: ...
...
def get_vehicle_colour(vehicle_id: int, primary_colour_out: bytearray, secondary_colour_out: bytearray) -> int: ...
...
def get_vehicle_turret_rotation(vehicle_id: int, horizontal_out: bytearray, vertical_out: bytearray) -> int: ...
def reset_all_vehicle_handlings() -> None: ...
def exists_handling_rule(model_index: int, rule_index: int) -> int: ...
...
def exists_inst_handling_rule(vehicle_id: int, rule_index: int) -> int: ...
...
def set_pickup_is_automatic(pickup_id: int, toggle: int) -> None: ...
...
def is_check_point_streamed_for_player(check_point_id: int, player_id: int) -> int: ...
def is_check_point_sphere(check_point_id: int) -> int: ...
...
def is_object_streamed_for_player(object_id: int, player_id: int) -> int: ...
...
def set_object_shot_report_enabled(object_id: int, toggle: int) -> None: ...
def is_object_shot_report_enabled(object_id: int) -> int: ...
def set_object_touched_report_enabled(object_id: int, toggle: int) -> None: ...
def is_object_touched_report_enabled(object_id: int) -> int: ...
def get_player_module_list(player_id: int) -> int: ...
def set_pickup_option(pickup_id: int, option: int, toggle: int) -> None: ...
def get_pickup_option(pickup_id: int, option: int) -> int: ...
