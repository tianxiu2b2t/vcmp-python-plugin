...
pub struct NPCExports {
    ...
    pub StartRecordingPlayerData: Option<
        extern "C" fn(
            playerId: i32,
            recordtype: u8,
    ...
    pub StartRecordingAllPlayerData:
        Option<extern "C" fn(recordtype: u8, flags: u32, recordnewplayers: bool) -> u8>,
    pub StopRecordingAllPlayerData: Option<extern "C" fn() -> u8>,
    pub IsPlayerRecording: Option<extern "C" fn(bytePlayerId: u8) -> bool>,
    pub PutServerInRecordingMode: Option<
        extern "C" fn(recordtype: u8, flags: u32, filename: *const ::std::os::raw::c_char) -> bool,
    >,
    ...
    pub ConnectMultipleNpcs: Option<
        extern "C" fn(
