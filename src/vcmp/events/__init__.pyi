...
class EventBuilder:
    ...
    # Checkpoint events
    @staticmethod
    def checkpoint_entered(checkpoint: CheckPoint, player: Player) -> 'EventBuilder': ...
    ...
    # Object events
    @staticmethod
    def object_shot(object: Object, player: Player, weapon_id: int) -> 'EventBuilder': ...
    ...
    # Player events
    @staticmethod
    def incoming_connection(ip: str, player_name: str, password: str) -> 'EventBuilder': ...
